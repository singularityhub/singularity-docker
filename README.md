...
branches, so that a single push to master doesn't trigger a build of all versions
 ...
 - [3.2-slim](https://github.com/singularityhub/singularity-docker/tree/3.2-slim): A multistage build that is smaller in size that builds to singularityware/singularity:3.2-slim.
 - [3.2](https://github.com/singularityhub/singularity-docker/tree/3.2): Builds to singularityware/singularity:3.2
